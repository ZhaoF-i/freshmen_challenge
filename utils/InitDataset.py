...
class DatasetInitial(object):
    def __init__(self):
        ...
        self.TT_SNR = [[-5], [0], [5]]
        self.TR_UTTERANCE_NUM = 320000
        self.CV_UTTERANCE_NUM = 3000
        self.TT_UTTERANCE_NUM = 300 * len(self.TT_SNR)

        self.TR_LST = 'tr.mat'
        self.CV_LST = 'cv.mat'
        self.CONFIG_PATH = '/home/data/zkh/data_environment/'
        self.TT_MIX_PATH = '/home/data/zkh/enhancement_data/standard_si84_test/'
        self.TT_CLEAN_PATH = '/home/data/zkh/enhancement_data/clean_si84_test/'
        self.TT_NOISE_PATH = '/home/data/zkh/enhancement_data/NOISE/'
        self.TT_NUM_SPEAKERS = 6

        self.NOISEBIN = '/home/data/zkh/enhancement_data/long_wav.bin'
        self.WAVBIN = '/home/data/zkh/enhancement_data/long_si84_one_tr_16k.bin'
    ...
    def rand_train(self):
        ...
        mat_path = self.CONFIG_PATH + 'tr.mat'
    ...
    def rand_val(self):
        ...
        mat_path = self.CONFIG_PATH + 'cv.mat'
        sio.savemat(mat_path, mat)
        return mat_path
            ...
            for spk_idx in range(self.TT_NUM_SPEAKERS):
                ...
                for utt_idx in range(num_data // 2):
                    for noise_idx in range(2):
                        ...
                        [mixture, nspeech, nnoise] = self.mixTargetAndNoise(speech, noise, snr[0])
                        ...
                        sf.write('%sS_%04d_%02d_%d_mix.wav' % (
                            self.TT_MIX_PATH, utt_idx + 25 * spk_idx, snr[0], noise_idx + 1), mixture, 16000)
                        sf.write('%sS_%04d_%02d_%d_clean.wav' % (
                            self.TT_MIX_PATH, utt_idx + 25 * spk_idx, snr[0], noise_idx + 1), nspeech, 16000)
                        sf.write('%sS_%04d_%02d_%d_noise.wav' % (
                            self.TT_MIX_PATH, utt_idx + 25 * spk_idx, snr[0], noise_idx + 1), nnoise, 16000)
                        count+=1
...
if __name__ == '__main__':
    ...
    # tr_lst_path = Intializer.rand_train()
    # cv_lst_path = Intializer.rand_val()
